...
class SpanLimits {
  ...
  int _maxNumAttributes = _DEFAULT_MAXNUM_ATTRIBUTES;
  int _maxNumEvents = _DEFAULT_MAXNUM_EVENTS;
  int _maxNumLink = _DEFAULT_MAXNUM_LINKS;
  int _maxNumAttributesPerEvent = _DEFAULT_MAXNUM_ATTRIBUTE_PER_EVENT;
  int _maxNumAttributesPerLink = _DEFAULT_MAXNUM_ATTRIBUTES_PER_LINK;
  int _maxNumAttributeLength = _DEFAULT_MAXNUM_ATTRIBUTES_LENGTH;
