...
void main() {
  ...
  test('span status', () {
    ...
    span.setStatus(api.StatusCode.error, description: 'Another error happened.');
    expect(span.status.code, equals(api.StatusCode.error));
    ...
    span.setStatus(api.StatusCode.unset, description: 'Oops.  Can we turn this back off?');
    expect(span.status.code, equals(api.StatusCode.error));
    expect(span.status.description, equals('Another error happened.'));
    ...
    span.setStatus(api.StatusCode.error, description: 'Something else went wrong.');
    expect(span.status.code, equals(api.StatusCode.ok));
    expect(span.status.description, equals('Another error happened.'));
  });
