...
void main() {
  test('startSpan new trace', () {
    final tracer = Tracer([], api.Resource([]), sdk.AlwaysOnSampler(), sdk.DateTimeTimeProvider(), sdk.IdGenerator(),
  ...
  test('startSpan child span', () {
    ...
    expect(childSpan.spanContext.spanId, allOf([isNotNull, isNot(equals(parentSpan.spanContext.spanId))]));
  });
}
