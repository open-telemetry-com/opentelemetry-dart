...
import 'package:opentelemetry_api/src/api/span_processors/span_processor.dart';
import 'package:opentelemetry_sdk/src/sdk/trace/tracer_provider.dart';
...
void main() {
  ...
  test('tracerProvider custom span processors', () {
    ...
    final provider = TracerProviderBase(processors: [mockProcessor1, mockProcessor2]);
  ...
  test('tracerProvider force flushes all processors', () {
    final mockProcessor1 = MockSpanProcessor();
    final mockProcessor2 = MockSpanProcessor();
    TracerProviderBase(processors: [mockProcessor1, mockProcessor2]).forceFlush();
